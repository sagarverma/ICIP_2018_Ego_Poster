...
\begin{poster}{
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \begin{center}
     \begin{tabular}{@{}c c@{}c}
       \tiny\textbf{RGB} &
       \raisebox{-.5\height}{\includegraphics[width=0.28\linewidth, height=12mm]{take_P_04_485}} &
       \raisebox{-.5\height}{\includegraphics[width=0.28\linewidth, height=12mm]{Walking_Huji_Ariel_13_23_87}}\\[-0.1em]
       \tiny\textbf{Flow} &
       \raisebox{-.5\height}{\includegraphics[width=0.28\linewidth, height=12mm]{take_P_04_485_F}}&
       \raisebox{-.5\height}{\includegraphics[width=0.28\linewidth, height=12mm]{Walking_Huji_Ariel_13_23_F_87}}\\[-0.1em]
       & \tiny\textbf{Take} & \tiny\textbf{Walking} \\[-0.1em]
     \end{tabular}
   \end{center}
   \footnotesize\textbf{Actions with hand-object interaction(take) and without(walking) in two different view streams.}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     \begin{enumerate}
      ...
      \begin{center}
      \begin{tabular}{@{}c@{}c@{}c}
        \includegraphics[width=0.28\linewidth, height=12mm]{spoon_imagenet}&
        \includegraphics[width=0.28\linewidth, height=12mm]{spoon_CofHoney}&
        \includegraphics[width=0.28\linewidth, height=12mm]{resized_spoon}\\[-0.1em]
        \includegraphics[width=0.28\linewidth, height=12mm]{bread_image_net}&
        \includegraphics[width=0.28\linewidth, height=12mm]{bread_S1CheeseC1}&
        \includegraphics[width=0.28\linewidth, height=12mm]{resized_bread}\\[-0.1em]
      \end{tabular}
      \end{center}
      {\footnotesize\textbf{After cropping and resizing the objects become comparable to the objects in third person videos.}}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         \begin{center}
           ...
           \includegraphics[width=1\linewidth, height=19mm]{S4_Cheese}
           ...
           \includegraphics[width=1\linewidth, height=19mm]{S4_hotdog}
           \scriptsize{Activity: Hotdog}
           \includegraphics[width=1\linewidth, height=19mm]{S4_Pealate}
           \scriptsize{Activity: Pealate}
           \includegraphics[width=1\linewidth, height=19mm]{S4_Peanut}
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \headerbox{References}{name=references,column=3,below=results2}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
